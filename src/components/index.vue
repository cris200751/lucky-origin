		...
		<div class="setting ">
			...
			<div class="main">
				<div class="list" id="imglist">
					<ul id="indexlist">
						<li><img class="trans-up delay-10" src="../../static/images/1e.png">
							<!--<p>SPORTSBOOK</p>-->
						</li>
						<li><img class="trans-up delay-15" src="../../static/images/2e.png">
							<!--<p>play to earn</p>-->
						</li>
						<li><img class="trans-up delay-20" src="../../static/images/3e.png">
							<!--<p>casino</p>-->
						</li>
					</ul>
					<ul id="indexlist2">
						<li><img class="trans-up delay-05" src="../../static/images/4e.png">
							<!--<p>LIVE CASINO</p>-->
						</li>
						<li><img class="trans-up delay-10" src="../../static/images/5ec.png">
							<!--<p>slots</p>-->
						</li>
						<li><img class="trans-up delay-15" src="../../static/images/6e.png">
							<!--<p>social games</p>-->
						</li>
					</ul>
				...
				<div class="intoset" id="intoset">
					<!--<div class="intoimg">
						<img class="trans-upfour" src="../../static/images/photoback.jpg" />
					</div>-->

					<div class="info trans-up delay-30">
						<p>lucky metas are fierce creatures that<br>love to battle, build, and hunt for treasure!</p>
						<p>build up a collection and use<br>them across an ever expanding universe<br>of Games!</p>
						<p>lucky meta uses cutting edge technology<br>called blockchain to reward players<br>for their engagement.</p>
					</div>
				</div>

				<div class="pingt">
					<img class="trans-up delay-20" src="../../static/images/zedhorse_red.gif" />
					<img class="trans-up delay-20" src="../../static/images/zedhorse_gold.gif" />
					<img class="trans-up delay-20" src="../../static/images/pint.png" />
				</div>
			</div>
		</div>
...
<script>
	...
	export default {
		...
		mounted() {
			...
			//			if(document.body.offsetWidth > 767) {
			//				window.addEventListener('scroll', this.allScroll)
			//			}
			$(".faq ul li p").click(function() {
		...
		methods: {
			allScroll() {
				...
				if(scrollTop < 600) {
					$('.index').css('transform', 'translate3d(0px, 0px, 0px)')
				} else if(scrollTop < 1400) {
					$('.index').css('transform', 'translate3d(0px, -' + scrollTop + 'px, 0px)')
				}
			...
			handleScroll() {
				...
				var offsetTop = Number(document.querySelector('#intoset').offsetTop)-100
				if(scrollTop > offsetTop) {
					$('#intoset').addClass('is-visible')
					$('.pingt').addClass('is-visible')
...
<style scoped>
	...
	.main .list {
		position: relative;
		/*background-image: url(../../static/images/22.gif);
		background-repeat: no-repeat;
		background-position: center 421px;
		background-size: 689px;*/
	}
	
	.main .list .backgroundgif {
		width: 689px;
		position: absolute;
		top: 421px;
		left: 50%;
	...
	.main .list .backgroundgif img:nth-child(1) {
		display: block;
		position: absolute;
		/*margin-top: -50px;*/
		z-index: 2;
	...
	.main .list .backgroundgif img:nth-child(2) {
		margin: -300px auto;
		display: block;
		margin-top: -360px;
	}
	...
	.main .list ul li img {
		display: block;
		margin: 0 auto;
		animation: moveto linear 3s infinite;
	}
	...
	.main .list ul:nth-child(1) li:nth-child(1) img {
		width: 290px;
		margin-top: 175px;
	}
	
	.main .list ul:nth-child(1) li:nth-child(2) img {
		margin-top: 75px;
		width: 335px;
		mix-blend-mode: screen;
	}
	
	.main .list ul:nth-child(1) li:nth-child(3) img {
		margin-top: 146px;
		width: 290px;
	}
	
	.main .list ul:nth-child(2) li:nth-child(1) img {
		margin-top: 241px;
		width: 290px;
	}
	
	.main .list ul:nth-child(2) li:nth-child(2) img {
		width: 290px;
		margin-top: 332px;
		/*margin-top: 292px;*/
		/*mix-blend-mode: screen;*/
	...
	.main .list ul:nth-child(2) li:nth-child(3) img {
		width: 290px;
		margin-top: 253px;
	}
	
	.main .list ul:nth-child(1) li:nth-child(1) p {
		top: 260px;
		margin-top: 241.5px;
		left: -5px;
	}
	
	.main .list ul:nth-child(1) li:nth-child(2) p {
		top: 255px;
		margin-top: 106.5px;
	}
	
	.main .list ul:nth-child(1) li:nth-child(3) p {
		top: 290px;
		margin-top: 175px;
	}
	
	.main .list ul:nth-child(2) li:nth-child(1) p {
		top: 230px;
		margin-top: 316.5px;
	}
	
	.main .list ul:nth-child(2) li:nth-child(2) p {
		top: 250px;
		margin-top: 504.5px;
	}
	
	.main .list ul:nth-child(2) li:nth-child(3) p {
		top: 190px;
		margin-top: 385px;
	}
	...
	.main .info {
		background-image: url(../../static/images/backgroundinfo.png);
		background-repeat: no-repeat;
